...
import aen1 from "assets/images/restaurant/antigua-menu/ingles/Menú (sin líneas guías) INGLES_page-0001.jpg";
import aen2 from "assets/images/restaurant/antigua-menu/ingles/Menú (sin líneas guías) INGLES_page-0002.jpg";
import aen3 from "assets/images/restaurant/antigua-menu/ingles/Menú (sin líneas guías) INGLES_page-0003.jpg";
import aen4 from "assets/images/restaurant/antigua-menu/ingles/Menú (sin líneas guías) INGLES_page-0004.jpg";
        ...
        <Container sx={{ mt: 4, mb: 6 }}>
          ...
          <Grid container justifyContent="center">
            <Grid item xs={12} lg={current.flipbook ? 8 : 8}>
              {current.flipbook && current.key === "chicago" ? (
